      ...
      {open&&(
        <div style={{padding:"14px 16px"}}>
          <div ref={container}>
            ...
            <div style={{textAlign:"right",padding:"4px 0"}}><a href="https://www.mql5.com/" rel="noopener nofollow" target="_blank" style={{color:"#475569",fontSize:9}}>MQL5 Economic Calendar</a></div>
          </div>
        </div>
      )}
    </div>
...
function SecaoBR_Margem({perfil,t}) {
...
function SecaoForex_Margem({perfil,t}) {
  const p=PERFIS_MARGEM[perfil];
...
function SecaoIndices_Margem({perfil,t}) {
  const p=PERFIS_MARGEM[perfil];
  const [capital,setCapital]=React.useState(500);
    ...
    <div style={{background:t.card,border:`1px solid ${t.border}`,borderRadius:14,overflow:"hidden",marginBottom:16}}>
      ...
      {open&&(
        <div style={{padding:"16px 18px"}}>
          ...
          <SecaoBR_Margem perfil={perfil} t={t}/>
          <SecaoForex_Margem perfil={perfil} t={t}/>
          <SecaoIndices_Margem perfil={perfil} t={t}/>
        </div>
      )}
    </div>
  );
